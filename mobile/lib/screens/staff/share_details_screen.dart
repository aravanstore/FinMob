  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: _C.bg,
        elevation: 0,
        title: const Text('История паёв', style: TextStyle(color: _C.textPri, fontSize: 18, fontWeight: FontWeight.bold)),
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                const Text('Заёмщик', style: TextStyle(color: _C.textSec, fontSize: 11)),
                const SizedBox(height: 4),
                Text(widget.clientName, style: const TextStyle(color: _C.textPri, fontSize: 16, fontWeight: FontWeight.bold)),
              ],
            ),
          ),
          ...
          Expanded(
            child: FutureBuilder<List<dynamic>>(
              ...
              builder: (context, snap) {
                ...
                if (list.isEmpty) {
                  return const Center(child: Text('Операций по паям еще не было', style: TextStyle(color: _C.textSec)));
                }
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(label, style: const TextStyle(color: _C.textPri, fontWeight: FontWeight.w600, fontSize: 14)),
                                const SizedBox(height: 4),
                          ...
                          Text(
                            ...
                            style: TextStyle(color: amount > 0 ? _C.green : _C.textPri, fontWeight: FontWeight.bold, fontSize: 15),
                          ),
                        ],
                      ),
                    );
